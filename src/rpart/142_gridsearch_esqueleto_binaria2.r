...
PARAM$semillas <- c(111422, 141122, 110022, 221411, 142211)
...
for (vmax_depth in c(4, 5, 7, 10, 14)) {
  for (vmin_split in c(1500, 1000, 400, 100, 50)) {
    for (vcp in c(-0.5, -1)) {
      for (vmin_bucket in c(700, 500, 200, 50, 20)) {   
