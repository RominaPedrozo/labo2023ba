...
PARAM$lgb_semilla <- 111422 # cambiar por su propia semilla
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.0001, upper = 0.3),
  makeNumericParam("feature_fraction", lower = 0.01, upper = 1.0),
  makeIntegerParam("num_leaves", lower = 8L, upper = 2000L),
  makeIntegerParam("min_data_in_leaf", lower = 50L, upper = 500000L),
  ...
  makeIntegerParam("lambda_l1", lower = 0L, upper = 10000L),
  makeIntegerParam("lambda_l2", lower = 0L, upper = 10000L),
  makeIntegerParam("bagging_freq", lower = 0L, upper = 10L),
  makeIntegerParam("min_gain_to_split", lower = 0L, upper = 10L),
  makeNumericParam("min_sum_hessian_in_leaf", lower = 0L, upper = 1000L)
)
