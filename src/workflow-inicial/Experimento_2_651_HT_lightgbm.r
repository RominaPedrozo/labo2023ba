...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeIntegerParam("num_iterations", lower = 1000, upper = 9999),
  makeIntegerParam("lambda_l1", lower = 1L, upper = 900L),
  makeIntegerParam("lambda_l2", lower = 1L, upper = 900L),
  makeIntegerParam("bagging_freq", lower = 0L, upper = 3L),
  makeIntegerParam("min_gain_to_split", lower = 0L, upper = 5L),
  makeIntegerParam("min_sum_hessian_in_leaf", lower = 0L, upper = 80L)
)
